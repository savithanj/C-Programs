 ...
 * of 15% of total amount is charged. Write a program to read the name
...
int main()
 {
	...
	{				// 90 paise per unit for the next 100 units and
		...
		total = (0.8 * 200) + (0.9 * 100) + (1 * (units - 300)) + METERCHARGE; 
